package com.adhi.cowboyshoot.ui.game
...
import com.adhi.cowboyshoot.databinding.ActivityGameBinding
import com.adhi.cowboyshoot.enum.GameState
import com.adhi.cowboyshoot.enum.PlayerPosition
import com.adhi.cowboyshoot.enum.PlayerSide
import com.adhi.cowboyshoot.manager.ComputerEnemyCowboyGameManager
import com.adhi.cowboyshoot.manager.CowboyGameListener
import com.adhi.cowboyshoot.manager.CowboyGameManager
import com.adhi.cowboyshoot.model.Player
...
class GameActivity : AppCompatActivity(), CowboyGameListener {
    ...
    private fun setCharacterMovement(player: Player, iconDrawableRes: Int) {
        ...
        if (player.playerSide == PlayerSide.PLAYER_ONE) {
            ...
            ivCharMiddle = binding.ivPlayerLeftMiddle
            ivCharBottom = binding.ivPlayerLeftBottom
        } else {
            ivCharTop = binding.ivPlayerRightTop
            ivCharMiddle = binding.ivPlayerRightMiddle
